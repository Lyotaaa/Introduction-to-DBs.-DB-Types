INSERT INTO music_genre (music_genre_id, name_genre)
    VALUES (1, 'Кантри-рэп'), 
           (2, 'Панк'), 
           (3, 'Рэп-рок'), 
           (4, 'Индастриал'), 
...
INSERT INTO performer (performer_id, name_performer)
    VALUES (1, 'Заточка'),
           (2, 'Rammstein'),
           (3, 'Noize MC'),
           (4, 'Oomph'),
...
INSERT INTO album (album_id, name_album, year_release)
...
INSERT INTO track(track_id, name_track, duration, album_id)
    VALUES (1, 'Мой новый шериф', 229, 1),
           (2, 'Батя бьёт маму', 202, 1),
           (3, 'Я люблю кантри', 162, 1),
           (4, 'Ich Tu Dir Weh', 301, 2),
           (5, 'Frühling in Paris', 284, 2),
           (6, 'My Pussy', 239, 2),
           (7, 'Make Some Noize', 213, 3),
           (8, 'чайлдфри', 244, 3),
           (9, 'Гвозди', 210, 3),
           (10, 'Augen Auf', 200, 4),
           (11, 'Sex Hat Keine Macht', 259, 4),
           (12, 'Brennende Liebe', 226, 4),
           (13, 'Свой среди чужих', 249, 5),
           (14, 'Ром', 161, 5),
           (15, 'Отражение', 332, 5),
           (16, 'Bismarck', 313, 6),
           (17, 'Verrückt', 201, 7),
           (18, 'Miststück 2012', 203, 7),
           (19, 'Tanz Mit Mir', 198, 7),
           (20, 'Черный октябрь', 227, 8),
           (21, 'Высота 776', 183, 8),
